    ...
    public class style
    {
        ...
        public void add_property(string name, string val, string baseurl, bool important)
        {
            ...
            if (name == "border")
            {
                ...
                foreach (var tok in tokens)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            add_property("border-front-color", tok, baseurl, important); //:h3ml
                            add_property("border-back-color", tok, baseurl, important); //:h3ml
                        }
                    }
                }
            }
                ...
                name == "border-top" ||
                name == "border-bottom" ||
                name == "border-front" ||//:h3ml
                name == "border-back") //:h3ml
            {
                var tokens = new List<string>();
                html.split_string(val, tokens, " ", "", "(");
                int idx;
        ...
        void parse_short_background(string val, string baseurl, bool important)
        {
            ...
            foreach (var tok in tokens)
            {
                ...
                else if (html.value_in_list(tok, "left;right;top;bottom;center") ||
                    char.IsDigit(tok[0]) || tok[0] == '-' || tok[0] == '.' || tok[0] == '+')
                {
