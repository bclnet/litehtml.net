...
namespace litehtml
{
    ...
    public class html_tag : element
    {
        ...
        public override void set_attr(string name, string val)
        {
            if (name != null && val != null)
            {
                ...
                if (name.StartsWith("on", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    doc.script?.addEvent(this, name.Substring(2).ToLowerInvariant(), val);
                }
            }
        }
        ...
        protected void parse_background()
        {
            ...
            _bg.m_color = get_color("background-color", false, new web_color(0, 0, 0, 0));
            ...
            if (str != null)
            {
                ...
                if (res.Count != 0)
                {
                    if (res.Count == 1)
                    {
                        if (html.value_in_list(res[0], "left;right;center")) { _bg.m_position.x.fromString(res[0], "left;right;center"); _bg.m_position.y.set_value(50, css_units.percentage); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                        else if (html.value_in_list(res[0], "top;bottom;center")) { _bg.m_position.y.fromString(res[0], "top;bottom;center"); _bg.m_position.x.set_value(50, css_units.percentage); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                        else if (html.value_in_list(res[0], "front;back;center")) { _bg.m_position.z.fromString(res[0], "front;back;center"); _bg.m_position.x.set_value(50, css_units.percentage); _bg.m_position.y.set_value(50, css_units.percentage); } //:h3ml
                        else { _bg.m_position.x.fromString(res[0], "left;right;center"); _bg.m_position.y.set_value(50, css_units.percentage); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                    }
                    else
                    {
                        if (html.value_in_list(res[0], "left;right")) { _bg.m_position.x.fromString(res[0], "left;right;center"); _bg.m_position.y.fromString(res[1], "top;bottom;center"); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                        else if (html.value_in_list(res[0], "top;bottom")) { _bg.m_position.x.fromString(res[1], "left;right;center"); _bg.m_position.y.fromString(res[0], "top;bottom;center"); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                        else if (html.value_in_list(res[1], "left;right")) { _bg.m_position.x.fromString(res[1], "left;right;center"); _bg.m_position.y.fromString(res[0], "top;bottom;center"); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                        else if (html.value_in_list(res[1], "top;bottom")) { _bg.m_position.x.fromString(res[0], "left;right;center"); _bg.m_position.y.fromString(res[1], "top;bottom;center"); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                        else { _bg.m_position.x.fromString(res[0], "left;right;center"); _bg.m_position.y.fromString(res[1], "top;bottom;center"); _bg.m_position.z.set_value(50, css_units.percentage); } //:h3ml
                    }

                    if (_bg.m_position.x.is_predefined)
                        switch (_bg.m_position.x.predef)
                        {
                            case 0: _bg.m_position.x.set_value(0, css_units.percentage); break;
                            case 1: _bg.m_position.x.set_value(100, css_units.percentage); break;
                            case 2: _bg.m_position.x.set_value(50, css_units.percentage); break;
                        }
                    if (_bg.m_position.y.is_predefined)
                        switch (_bg.m_position.y.predef)
                        {
                            case 0: _bg.m_position.y.set_value(0, css_units.percentage); break;
                            case 1: _bg.m_position.y.set_value(100, css_units.percentage); break;
                            case 2: _bg.m_position.y.set_value(50, css_units.percentage); break;
                        }
                    //:h3ml
                    if (_bg.m_position.z.is_predefined) //:h3ml
                        switch (_bg.m_position.z.predef) //:h3ml
                        {
                            case 0: _bg.m_position.z.set_value(0, css_units.percentage); break; //:h3ml
                            case 1: _bg.m_position.z.set_value(100, css_units.percentage); break; //:h3ml
                            case 2: _bg.m_position.z.set_value(50, css_units.percentage); break; //:h3ml
                        }
                }
                else { _bg.m_position.x.set_value(0, css_units.percentage); _bg.m_position.y.set_value(0, css_units.percentage); _bg.m_position.z.set_value(0, css_units.percentage); } //:h3ml
            }
            else { _bg.m_position.y.set_value(0, css_units.percentage); _bg.m_position.x.set_value(0, css_units.percentage); _bg.m_position.z.set_value(0, css_units.percentage); } //:h3ml
            ...
            if (str != null)
            {
                ...
                if (res.Count != 0)
                {
                    _bg.m_position.width.fromString(res[0], types.background_size_strings);
                    if (res.Count > 1) _bg.m_position.height.fromString(res[1], types.background_size_strings);
                    else _bg.m_position.height.predef = (int)background_size.auto;
                    if (res.Count > 2) _bg.m_position.depth.fromString(res[2], types.background_size_strings); //:h3ml
                    else _bg.m_position.depth.predef = (int)background_size.auto; //:h3ml
                }
                else
                {
                    _bg.m_position.width.predef = (int)background_size.auto;
                    _bg.m_position.height.predef = (int)background_size.auto;
                    _bg.m_position.depth.predef = (int)background_size.auto; //:h3ml
                }
            }

            var doc = get_document();
            doc.cvt_units(_bg.m_position.x, _font_size);
            doc.cvt_units(_bg.m_position.y, _font_size);
            doc.cvt_units(_bg.m_position.z, _font_size); //:h3ml
            doc.cvt_units(_bg.m_position.width, _font_size);
            doc.cvt_units(_bg.m_position.height, _font_size);
            doc.cvt_units(_bg.m_position.depth, _font_size); //:h3ml

            // parse background_attachment
            _bg.m_attachment = (background_attachment)html.value_index(
                get_style_property("background-attachment", false, "scroll"),
                types.background_attachment_strings, (int)background_attachment.scroll);

            // parse background_attachment
            _bg.m_repeat = (background_repeat)html.value_index(
                get_style_property("background-repeat", false, "repeat"),
                types.background_repeat_strings, (int)background_repeat.repeat);

            // parse background_clip
            _bg.m_clip = (background_box)html.value_index(
                get_style_property("background-clip", false, "border-box"),
                types.background_box_strings, (int)background_box.border);

            // parse background_origin
            _bg.m_origin = (background_box)html.value_index(
                get_style_property("background-origin", false, "padding-box"),
                types.background_box_strings, (int)background_box.content);

            // parse background-image
            css.parse_css_url(get_style_property("background-image", false, ""), out _bg.m_image);
            _bg.m_baseurl = get_style_property("background-image-baseurl", false, "");

            if (!string.IsNullOrEmpty(_bg.m_image))
                doc.container.load_image(_bg.m_image, string.IsNullOrEmpty(_bg.m_baseurl) ? null : _bg.m_baseurl, null, true);
        }
        ...
        {
            if (get_element_position() != element_position.absolute && (_display == style_display.block || _display == style_display.table))
            {
        ...
        {
            if (_children.Count != 0)
                foreach (var this_el in _children.FastReverse())
                    if (!this_el.is_white_space())
                    {
                        if (el == this_el)
                            return true;
        ...
        public override css_length get_css_front() => _css_offsets.front;

        public override css_length get_css_back() => _css_offsets.back;
        ...
        public override css_length get_css_depth() => _css_depth;
        ...
        protected void init_background_paint(position pos, background_paint bg_paint, background bg)
        {
            ...
            switch (bg.m_clip)
            {
                case background_box.padding: bg_paint.clip_box = padding_box; break;
                case background_box.content: bg_paint.clip_box = content_box; break;
                default: bg_paint.clip_box = border_box; break;
            }

            switch (bg.m_origin)
            {
                case background_box.border: bg_paint.origin_box = border_box; break;
                case background_box.content: bg_paint.origin_box = content_box; break;
                default: bg_paint.origin_box = padding_box; break;
            }

            if (!string.IsNullOrEmpty(bg_paint.image))
            {
                get_document().container.get_image_size(bg_paint.image, bg_paint.baseurl, null, out bg_paint.image_size);
                if (bg_paint.image_size.width != 0 && bg_paint.image_size.height != 0)
                {
                    ...
                    if (bg.m_position.width.is_predefined)
                        switch ((background_size)bg.m_position.width.predef)
                        {
                    ...
                    else
                    {
                        ...
                        img_new_sz.height = bg.m_position.height.is_predefined
                            ? (int)(img_new_sz.width * img_ar_height)
                            : bg.m_position.height.calc_percent(bg_paint.origin_box.height);
                        img_new_sz.depth = 0; //:h3ml
                    }

                    bg_paint.image_size = img_new_sz;
                    bg_paint.position_x = bg_paint.origin_box.x + bg.m_position.x.calc_percent(bg_paint.origin_box.width - bg_paint.image_size.width);
                    bg_paint.position_y = bg_paint.origin_box.y + bg.m_position.y.calc_percent(bg_paint.origin_box.height - bg_paint.image_size.height);
                    bg_paint.position_z = bg_paint.origin_box.z + bg.m_position.z.calc_percent(bg_paint.origin_box.depth - bg_paint.image_size.depth); //:h3ml
                }
            }
        ...
        protected void draw_list_marker(object hdc, position pos)
        {
            ...
            if (list_image != null)
            {
                ...
                get_document().container.get_image_size(lm.image, lm.baseurl, null, out img_size);
            }
            ...
            foreach (var el in _positioned)
            {
                ...
                if (process)
                {
                    ...
                    if (el_position == element_position.@fixed)
                    {
                        ...
                        client_z = wnd_position.front; //:h3ml
                    }
                    else
                    {
                        var el_parent = el.parent();
                    ...
                    else
                    {
                        ...
                        if (!css_front.is_predefined || !css_back.is_predefined) //:h3ml
                        {
                            ...
                            else if (css_front.is_predefined && !css_back.is_predefined) el._pos.z = _pos.depth + _padding.back - css_back.calc_percent(parent_depth) - el._pos.depth - el.content_margins_back; //:h3ml
                            else
                            {
                                el._pos.z = css_front.calc_percent(parent_depth) + el.content_margins_front - _padding.front; //:h3ml
                                el._pos.depth = _pos.depth + _padding.front + _padding.back - css_front.calc_percent(parent_depth) - css_back.calc_percent(parent_depth) - (el.content_margins_front + el.content_margins_back); //:h3ml
                                if (new_depth != -1)
                                {
        ...
        public override void get_redraw_box(ref position pos, int x = 0, int y = 0, int z = 0)
        {
            if (is_visible)
            {
                ...
                if (_overflow == overflow.visible)
                    foreach (var el in _children)
                        if (el.get_element_position() != element_position.@fixed)
        ...
        public override background get_background(bool own_only = false)
        {
            if (own_only)
            {
                ...
                if (string.IsNullOrEmpty(_bg.m_image) && _bg.m_color.alpha == 0)
                    return null;
                return _bg;
            }
        ...
        protected int render_box(int x, int y, int z, int max_width, bool second_pass = false) //:h3ml
        {
            ...
            var ws = get_white_space;
            var skip_spaces = ws == white_space.normal ||
                ws == white_space.nowrap ||
                ws == white_space.pre_line;
            ...
            if (_display == style_display.list_item)
            {
                ...
                if (list_image != null)
                {
                    ...
                    var list_image_baseurl = get_style_property("list-style-image-baseurl", true, null);
                    get_document().container.get_image_size(url, list_image_baseurl, null, out var sz);
        ...
        protected int render_table(int x, int y, int z, int max_width, bool second_pass = false) //:h3ml
        {
            ...
            if (!_css_min_height.is_predefined && _css_min_height.units == css_units.percentage)
            {
                ...
                if (el_parent != null)
                {
                    if (el_parent.get_predefined_height(out var parent_height))
            ...
            foreach (var item in _children)
            {
                ...
                if (el.is_visible)
                {
                    ...
                    if (el != null)
                        ...
                        {
                            if (el.get_float == element_float.none &&
                                el.get_display != style_display.inline_block &&
                                !el.is_positioned)
                                el.draw_children(hdc, pos.x, pos.y, pos.z, clip, flag, zindex); //:h3ml
                        }
                }
