namespace litehtml
{
    public class el_asset : html_tag
    {
        ...
        public override void get_content_size(out size sz, int max_width) => get_document().container.get_image_size(_src, null, _attrs, out sz);

        int calc_max_height(int asset_height)
        {
        ...
        public override int render(int x, int y, int z, int max_width, bool second_pass = false)
        {
            ...
            doc.container.get_image_size(_src, null, _attrs, out var sz);
        ...
        public override void parse_styles(bool is_reparse = false)
        {
            ...
            if (!string.IsNullOrEmpty(_src))
                get_document().container.load_image(_src, null, _attrs, !_css_height.is_predefined && !_css_width.is_predefined);
        }
    }
}
