...
namespace litehtml
{
    ...
    public interface Icontainer
    {
        ...
        void load_image(string src, string baseurl, Dictionary<string, string> attrs, bool redraw_on_ready);
        void get_image_size(string src, string baseurl, Dictionary<string, string> attrs, out size sz);
    ...
    {
        public static string index_value(int index, string strings, char delim = ';')
        {
        ...
        public static bool t_isdigit(int c)
            => c >= '0' && c <= '9';

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int t_tolower(int c)
            => c >= 'A' && c <= 'Z' ? c + 'a' - 'A' : c;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int round_f(float val)
        {
            int int_val = (int)val;
            if (val - int_val >= 0.5)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int round_d(double val)
        {
            int int_val = (int)val;
            if (val - int_val >= 0.5)
            {
