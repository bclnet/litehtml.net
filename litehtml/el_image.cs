namespace litehtml
{
    public class el_image : html_tag
    {
        ...
        public override void get_content_size(out size sz, int max_width) => get_document().container.get_image_size(_src, null, null, out sz);
        ...
        public override int render(int x, int y, int z, int max_width, bool second_pass = false)
        {
            ...
            doc.container.get_image_size(_src, null, null, out var sz);
        ...
        public override void parse_styles(bool is_reparse = false)
        {
            ...
            if (!string.IsNullOrEmpty(_src))
                get_document().container.load_image(_src, null, null, !_css_height.is_predefined && !_css_width.is_predefined);
        }
    }
}
